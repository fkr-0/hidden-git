...
HiddenGit is a small self-hosted Git forge that exposes Soft Serve's SSH interface through a Tor v3 onion service. Release `0.1.3` targets a narrow operating model:
