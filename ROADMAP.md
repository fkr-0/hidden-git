...
HiddenGit `0.1.3` is the current release line. It adds schema-v1 configuration convergence, a smaller SSH-only network surface, Soft Serve v0.12.2 security updates, stale-config E2E protection, release-bound documentation for `hiddengit.fkr.dev`, and CI portability fixes on top of the `0.0.3` hardening baseline.
